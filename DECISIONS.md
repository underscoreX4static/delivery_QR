...
| **D7** | Timing du crédit parrainage (Phase 3) | **Asymétrique** : filleul crédité à l'**approbation** (utilisable sur sa 1ʳᵉ commande) ; parrain crédité à la **1ʳᵉ livraison** du filleul | Révisé en Phase 3 : le crédit filleul est le levier d'acquisition, il doit s'appliquer dès la commande #1 → crédité à l'approbation admin (qui reste le garde-fou). Le parrain n'est récompensé que quand le parrainage convertit en vraie vente livrée. Pas de seuil sur le nombre de commandes du parrain. |
